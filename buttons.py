...
def main_page():
    ...
    with col1:
        if st.button("Outdoor Environmental Data", key="outdoor", css_classes=["custom-button"], id="outdoor"):
            st.session_state.page = "outdoor"
        if st.button("Indoor Environmental Data", key="indoor", css_classes=["custom-button"], id="indoor"):
            st.session_state.page = "indoor"

    with col2:
        if st.button("Medical Data", key="medical", css_classes=["custom-button"], id="medical"):
            st.session_state.page = "medical"
        if st.button("Social Data", key="social", css_classes=["custom-button"], id="social"):
