...
st.markdown("""
    <style>
        ...
        div.stButton > button.back { background-color: #555; } /* Gray for Back */
        ...
        div.stButton > button.back:hover { background-color: #333; } /* Darker Gray */
    </style>
...
def outdoor_page():
    ...
    if st.button("Back", key="back_outdoor", help="Back to Main Menu"):
...
def indoor_page():
    ...
    if st.button("Back", key="back_indoor", help="Back to Main Menu"):
        st.session_state.page = "main"

# Medical Page
def medical_page():
    st.write("[Go to Medical Dashboard](https://www.statista.com/topics/6349/healthcare-system-in-italy/)")
    if st.button("Back", key="back_medical", help="Back to Main Menu"):
        st.session_state.page = "main"
...
def social_page():
    ...
    if st.button("Back", key="back_social", help="Back to Main Menu"):
        st.session_state.page = "main"
